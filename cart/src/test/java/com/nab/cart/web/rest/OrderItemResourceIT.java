...
public class OrderItemResourceIT {
    ...
    @Test
    @Transactional
    public void getAllOrderItemsByProductNameIsEqualToSomething() throws Exception {
        // Initialize the database
        orderItemRepository.saveAndFlush(orderItem);

        // Get all the orderItemList where productName equals to DEFAULT_PRODUCT_NAME
        defaultOrderItemShouldBeFound("productName.equals=" + DEFAULT_PRODUCT_NAME);

        // Get all the orderItemList where productName equals to UPDATED_PRODUCT_NAME
        defaultOrderItemShouldNotBeFound("productName.equals=" + UPDATED_PRODUCT_NAME);
    }

    @Test
    @Transactional
    public void getAllOrderItemsByProductNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        orderItemRepository.saveAndFlush(orderItem);

        // Get all the orderItemList where productName not equals to DEFAULT_PRODUCT_NAME
        defaultOrderItemShouldNotBeFound("productName.notEquals=" + DEFAULT_PRODUCT_NAME);

        // Get all the orderItemList where productName not equals to UPDATED_PRODUCT_NAME
        defaultOrderItemShouldBeFound("productName.notEquals=" + UPDATED_PRODUCT_NAME);
    }

    @Test
    @Transactional
    public void getAllOrderItemsByProductNameIsInShouldWork() throws Exception {
        // Initialize the database
        orderItemRepository.saveAndFlush(orderItem);

        // Get all the orderItemList where productName in DEFAULT_PRODUCT_NAME or UPDATED_PRODUCT_NAME
        defaultOrderItemShouldBeFound("productName.in=" + DEFAULT_PRODUCT_NAME + "," + UPDATED_PRODUCT_NAME);

        // Get all the orderItemList where productName equals to UPDATED_PRODUCT_NAME
        defaultOrderItemShouldNotBeFound("productName.in=" + UPDATED_PRODUCT_NAME);
    }

    @Test
    @Transactional
    public void getAllOrderItemsByProductNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        orderItemRepository.saveAndFlush(orderItem);

        // Get all the orderItemList where productName is not null
        defaultOrderItemShouldBeFound("productName.specified=true");

        // Get all the orderItemList where productName is null
        defaultOrderItemShouldNotBeFound("productName.specified=false");
    }
                @Test
    @Transactional
    public void getAllOrderItemsByProductNameContainsSomething() throws Exception {
        // Initialize the database
        orderItemRepository.saveAndFlush(orderItem);

        // Get all the orderItemList where productName contains DEFAULT_PRODUCT_NAME
        defaultOrderItemShouldBeFound("productName.contains=" + DEFAULT_PRODUCT_NAME);

        // Get all the orderItemList where productName contains UPDATED_PRODUCT_NAME
        defaultOrderItemShouldNotBeFound("productName.contains=" + UPDATED_PRODUCT_NAME);
    }

    @Test
    @Transactional
    public void getAllOrderItemsByProductNameNotContainsSomething() throws Exception {
        // Initialize the database
        orderItemRepository.saveAndFlush(orderItem);

        // Get all the orderItemList where productName does not contain DEFAULT_PRODUCT_NAME
        defaultOrderItemShouldNotBeFound("productName.doesNotContain=" + DEFAULT_PRODUCT_NAME);

        // Get all the orderItemList where productName does not contain UPDATED_PRODUCT_NAME
        defaultOrderItemShouldBeFound("productName.doesNotContain=" + UPDATED_PRODUCT_NAME);
    }
