...
export const ProductOrderDeleteDialog = (props: IProductOrderDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.cartProductOrder.delete.question">
        <Translate contentKey="gatewayApp.cartProductOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
