  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.cartProductOrder.home.createOrEditLabel">
            <Translate contentKey="gatewayApp.cartProductOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productOrderEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="placedDateLabel" for="product-order-placedDate">
                  <Translate contentKey="gatewayApp.cartProductOrder.placedDate">Placed Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="statusLabel" for="product-order-status">
                  <Translate contentKey="gatewayApp.cartProductOrder.status">Status</Translate>
                </Label>
                <AvInput
                  ...
                  className="form-control"
                  name="status"
                  value={(!isNew && productOrderEntity.status) || 'PENDING'}
                >
              ...
              <AvGroup>
                <Label id="codeLabel" for="product-order-code">
                  <Translate contentKey="gatewayApp.cartProductOrder.code">Code</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="customerLabel" for="product-order-customer">
                  <Translate contentKey="gatewayApp.cartProductOrder.customer">Customer</Translate>
                </Label>
                <AvField
