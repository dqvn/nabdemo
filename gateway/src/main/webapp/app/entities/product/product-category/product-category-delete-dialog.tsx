...
export const ProductCategoryDeleteDialog = (props: IProductCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.productProductCategory.delete.question">
        <Translate contentKey="gatewayApp.productProductCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
