  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.productProductCategory.home.createOrEditLabel">
            <Translate contentKey="gatewayApp.productProductCategory.home.createOrEditLabel">Create or edit a ProductCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productCategoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="product-category-name">
                  <Translate contentKey="gatewayApp.productProductCategory.name">Name</Translate>
                </Label>
                <AvField
