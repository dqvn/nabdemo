  ...
  return (
    <div>
      <h2 id="product-category-heading">
        <Translate contentKey="gatewayApp.productProductCategory.home.title">Product Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gatewayApp.productProductCategory.home.createLabel">Create new Product Category</Translate>
        </Link>
      </h2>
        ...
        {productCategoryList && productCategoryList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="gatewayApp.productProductCategory.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="gatewayApp.productProductCategory.description">Description</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.productProductCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )
        )}
      </div>
