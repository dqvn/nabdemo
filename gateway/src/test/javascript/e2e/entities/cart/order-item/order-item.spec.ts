...
describe('OrderItem e2e test', () => {
  ...
  it('should load create OrderItem page', async () => {
    ...
    expect(await orderItemUpdatePage.getPageTitle().getAttribute('id')).to.match(/gatewayApp.cartOrderItem.home.createOrEditLabel/);
  ...
  /*  it('should create and save OrderItems', async () => {
        ...
        await orderItemUpdatePage.setProductNameInput('productName');
        expect(await orderItemUpdatePage.getProductNameInput()).to.match(/productName/);
  ...
  /*  it('should delete last OrderItem', async () => {
        ...
        expect(await orderItemDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gatewayApp.cartOrderItem.delete.question/);
