...
describe('ProductOrder e2e test', () => {
  ...
  it('should load create ProductOrder page', async () => {
    ...
    expect(await productOrderUpdatePage.getPageTitle().getAttribute('id')).to.match(/gatewayApp.cartProductOrder.home.createOrEditLabel/);
  ...
  it('should delete last ProductOrder', async () => {
    ...
    expect(await productOrderDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gatewayApp.cartProductOrder.delete.question/);
