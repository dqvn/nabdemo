...
describe('Product e2e test', () => {
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle().getAttribute('id')).to.match(/gatewayApp.productProduct.home.createOrEditLabel/);
  ...
  it('should create and save Products', async () => {
    ...
    await productUpdatePage.brandSelectLastOption();
    await productUpdatePage.setPriceInput('5');
    expect(await productUpdatePage.getPriceInput()).to.eq('5');
    await productUpdatePage.productColorSelectLastOption();
    await productUpdatePage.productSizeSelectLastOption();
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gatewayApp.productProduct.delete.question/);
