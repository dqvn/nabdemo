...
import com.nab.product.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.nab.product.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    public ResponseEntity<Product> updateProduct(@Valid @RequestBody Product product) throws URISyntaxException {
        ...
        Product result = null;
        // check if product price change, then create new object with new price and keep the current object with old price with OLD status
